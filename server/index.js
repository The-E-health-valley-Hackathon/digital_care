...
const etiquetteRoute = require ("./routes/etiquetteRoute")
const fichefabrication=require("./routes/fichefabricationRoute")
const app = express();
...
app.use("/etiquette",etiquetteRoute)
app.use("/fabrication",fichefabrication)
sequelize
  .authenticate()
  .then(() => {
